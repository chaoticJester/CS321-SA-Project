...
const columns: { key: Exclude<keyof Item, 'id'>; label: string; numeric?: boolean }[] = [
  { key: 'budgetCode', label: 'Budget Code' }, { key: 'name', label: 'Name' }, { key: 'brand', label: 'Brand' }, { key: 'model', label: 'Model' }, { key: 'detail', label: 'Detail' }, { key: 'quantity', label: 'QTY / จำนวน', numeric: true }, { key: 'unit', label: 'Unit / หน่วยนับ' }, { key: 'price', label: 'Unit Price / ราคาต่อหน่วย', numeric: true },
]
